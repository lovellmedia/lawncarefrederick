export const site = {
  "dir": "lawncarefrederick",
  "domain": "lawncarefrederick.com",
  "title": "Lawn Care Frederick",
  "business": "Lawn Care Frederick",
  "phone": "(240) 555-0164",
  ...
  "imageIndex": 1,
  "noun": "lawn care plan",
  "plural": "lawn care plans",
  "proof": [
    "Weekly mowing routes",
    "Turf health programs",
    "Seasonal cleanup crews",
  ...
  "families": [
    {
      ...
      "shortDescription": "Lawn Maintenance for Frederick properties with clear planning, careful workmanship, and local service context.",
      "keyPoints": [
        "Frederick-specific lawn maintenance planning",
        "Clear estimates and staged scheduling",
    ...
    {
      "slug": "turf-health",
      "name": "Turf Health Programs",
      "shortDescription": "Turf Health Programs for Frederick properties with clear planning, careful workmanship, and local service context.",
      "keyPoints": [
        "Frederick-specific turf health programs planning",
        "Clear estimates and staged scheduling",
        "Clean, documented completion standards"
      ],
      "overview": [
    ...
    {
      "slug": "seasonal-yard-care",
      "name": "Seasonal Yard Care",
      "shortDescription": "Seasonal Yard Care for Frederick properties with clear planning, careful workmanship, and local service context.",
      "keyPoints": [
        "Frederick-specific seasonal yard care planning",
        "Clear estimates and staged scheduling",
        "Clean, documented completion standards"
      ],
      "overview": [
    ...
    {
      "slug": "property-enhancements",
      "name": "Property Enhancements",
      "shortDescription": "Property Enhancements for Frederick properties with clear planning, careful workmanship, and local service context.",
      "keyPoints": [
        "Frederick-specific property enhancements planning",
        "Clear estimates and staged scheduling",
        "Clean, documented completion standards"
      ],
      "overview": [
    ...
    {
      "slug": "specialty-lawn-services",
      "name": "Specialty Lawn Services",
      "shortDescription": "Specialty Lawn Services for Frederick properties with clear planning, careful workmanship, and local service context.",
      "keyPoints": [
        "Frederick-specific specialty lawn services planning",
        "Clear estimates and staged scheduling",
        "Clean, documented completion standards"
      ],
      "overview": [
...
export const serviceFamilies = site.families;
export const allChildren = serviceFamilies.flatMap((family) => family.children.map((child) => ({ ...child, parentSlug: family.slug, parentName: family.name })));
...
export function makeTitle(pageTitle) { return `${pageTitle} | ${site.title}`; }
export function makeServiceTitle(serviceName) { return `${serviceName} in ${site.city || 'Frederick'}, Maryland | ${site.title}`; }
export function getSiblingChildren(parentSlug, childSlug) {
  const family = serviceFamilies.find((item) => item.slug === parentSlug);
  return family ? family.children.filter((child) => child.slug !== childSlug) : [];
}
